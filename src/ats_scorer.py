...
def _required_section_patterns():
    """Return patterns used to locate required skills."""
...
def _preferred_section_patterns():
    """Return patterns used to locate preferred skills."""
